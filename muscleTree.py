...
def getAlignTree(filename,treepath,outpath,muscle_exe):
    ...
    muscle_exe = "/Users/kprovost/Documents/Side_Projects/Africa_Genbank/muscle3.8.31_i86darwin64"
...
def main():
    ...
    try:
        ...
        print("/Users/kprovost/Documents/Side_Projects/Africa_Genbank/muscle3.8.31_i86darwin64")
        muscle_exe = "/Users/kprovost/Documents/Side_Projects/Africa_Genbank/muscle3.8.31_i86darwin64"
    ...
    try:
        ...
        path = os.getcwd()+"/5_withrev/"
        print("Path is current directory + 5_withrev") 

    treepath = cwd+"/6_alignmenttrees/"
    if not os.path.exists(treepath):
        print("creating folder: ",treepath)
        os.makedirs(treepath)   
        
    outpath = cwd+"/7_readytoalign/"
